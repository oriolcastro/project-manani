...
exports.handler = function(event, context, callback) {
  ...
  const candidateType =
    params.candidateType === 'Autocandidatura'
      ...
      : 'La comissió de llistes es posarà en contacte amb la persona que has proposat un cop rebudes totes les propostes per coneixer la seva voluntat de formar part de la llista electoral.'
